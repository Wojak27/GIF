...
def compare_to_groundtruth(gt, dt, dist='iou', distfields=None, distth=0.5, vflag=''):
    ...
    print("Length of allframeids: ", len(allframeids), "Length of fid_to_fgt: ", len(fid_to_fgt), "Length of fid_to_fdt: ", len(fid_to_fdt), "Same length: ", len(fid_to_fgt) == len(fid_to_fdt))
