...
def make_parser():
    ...
    parser.add_argument("--only_eval", dest="only_eval", default=False, action="store_true", help="Only eval, no detections",)
    parser.add_argument("--bytetrack", dest="bytetrack", default=False, action="store_true", help="Use ByteTrack",)
    parser.add_argument("--one_video", dest="one_video", default=False, action="store_true", help="Run only one video",)
    ...
    # NBA tracking + ReID + ID
    parser.add_argument("--yolo_model", type=str, default="yolo_model", help="Provides the name of YOLOX model to be used")
    parser.add_argument("--feature_extractor", type=str, default="CLIP",choices=["CLIP", "ap3d"], help="Provides the name of Feature extractor model to be used")
    parser.add_argument("--use_text", dest="use_text", default=False, action="store_true", help="use text for evaluation")
    parser.add_argument("--text_path", type=str, default="", help="Provides the path to text features")
    parser.add_argument("--use_gallery", dest="use_gallery", default=False, action="store_true", help="If gallery embeddings should be used for person Identification")
    parser.add_argument("--gallery_path", type=str, default="", help="Provides the path to gallery features")
    parser.add_argument("--reid_thresh", type=float, default=0.5, help="matching threshold for tracking")
    parser.add_argument("--id_level", type=str, default="global", help="Determines the scope of player identification") # global, game
    parser.add_argument("--average_query_embeds", type=int, default=1, help="Amount of frames query embed should be averaged over.")
    parser.add_argument("--use_clip_projection", dest="use_clip_projection", default=False, action="store_true", help="Use Extra CLIP model projection")
    parser.add_argument("--clip_projection_weights", type=str, default="", help="Extra Clip projection Weights")
    ...
    parser.add_argument("--use_clustering", dest="use_clustering", default=False, action="store_true", help="Use Clustering of embeddings")
    parser.add_argument("--scale_embedding_with_confidence", dest="scale_embedding_with_confidence", default=False, action="store_true", help="Use Confidence to scale embeddings")
    ...
    parser.add_argument("--version", default=1.0, type=int, help="Version of the clipreid tracker")
